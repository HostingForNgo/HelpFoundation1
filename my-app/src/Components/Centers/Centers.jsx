...
export default function Centers() {
    return (
        <Box overflow={"hidden"} minHeight={["100vw","65vw","45vw"]} sx={{display:"flex",alignItems:"center",flexDirection:"column",color:"black"}} justifyContent={"space-evenly"}>
        <Typography sx={{ marginTop: "20px",letterSpacing:"4px"}} color={"black"} fontWeight="700" variant="h4" mb={"20px"}>OUR CENTERS</Typography>
