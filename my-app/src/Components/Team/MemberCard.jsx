...
export default function MemberCard({ img, name, description, role }) {
    ...
    return (
        ...
        >
            <Box className={"card"} overflow={"hidden"} borderRadius={"50px 0 50px 0"} boxShadow={"rgba(0, 0, 0, 0.24) 0px 3px 8px"} position={"relative"} flexShrink={0} minHeight={["500px", "485px", "500px", "500px"]}>
                <Box className="content">
                 <Box className={"front"}>
                     ...
                     <Box padding={"20px"} width={"100%"} height={"25%"}>
                            <Typography fontWeight={"800"} fontSize={"18px"}>{name}</Typography>
                         <Typography fontWeight={"800"} fontSize={"13px"}>{role}</Typography>
