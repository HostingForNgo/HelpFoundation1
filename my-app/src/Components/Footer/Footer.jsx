    ...
    return (
        <>
            <motion.div
                ...
                <Box bgcolor={"#33343f"} minHeight={"900px"} p={"10px"} paddingTop={"70px"} flexDirection={"column"} display={"flex"} alignItems={"center"} gap={"30px"}>
                    ...
                    <Box display={"flex"} flexDirection={"column"} alignItems={"center"} width={["100%", "100%", "100%", "940px"]} gap={"20px"}>
                        <Box width={"100%"} display={"flex"} gap={'20px'} flexDirection={["column", "column", "column", "row"]} justifyContent={"space-between"}>
                            <FooterInputBox val={name} onInput={setName} placeholder={"Enter You Name"} width={["100%", "100%", "100%", "49%"]} text={"Name *"} />
                            <FooterInputBox val={email} onInput={setEmail} placeholder={"Enter You Email"} width={["100%", "100%", "100%", "49%"]} text={"Email *"} />
                        </Box>
                        <Box width={"100%"} display={"flex"} gap={'20px'} flexDirection={["column", "column", "column", "row"]} justifyContent={"space-between"}>
                            <FooterInputBox val={phone} onInput={setPhone} placeholder={"Enter You Phone Number"} width={["100%", "100%", "100%", "49%"]} text={"Phone"} />
                            <FooterInputBox val={address} onInput={setAddress} placeholder={"Enter You Address"} width={["100%", "100%", "100%", "49%"]} text={"Address"} />
                        </Box>
                        <Box width={"100%"} display={"flex"} gap={'20px'} justifyContent={"space-between"}>
                            <FooterInputBox val={subject} onInput={setSubject} placeholder={"Type the Subject"} width={"100%"} text={"Subject"} />
                        </Box>
                        <Box width={"100%"} display={"flex"} gap={'20px'} justifyContent={"space-between"}>
                            <Box width={"100%"}>
                                <Typography ml={"5px"} fontSize={"15px"} color={"white"}>Message</Typography>
                                <textarea value={message} onInput={e => setMessage(e.target.value)} placeholder="Type you Message" style={{ height: "116px", resize: "none" }} className="footerInput" />
                            </Box>
                        </Box>
                        <button onClick={() => {
                            let data = {
                            ...
                            className={"footerButton"}>Submit</button>
                    </Box>
                </Box>
                <Box minHeight={"200px"} display={"flex"} alignItems={"center"} justifyContent={"space-evenly"} flexDirection={"column"} padding={["20px", "20px", "20px", "0"]}>
                    <Box display={"flex"} flexDirection={["column", "column", "column", "row"]} justifyContent={"space-between"} alignItems={"center"} width={["100%", "100%", "100%", "940px"]} gap={"20px"}>
